...
import com.alura.foro.domain.usuario.DatosAuntenticacionUsuario;
...
public class AutenticacionController {
    ...
    public ResponseEntity autenticarUsuario(@RequestBody @Valid DatosAuntenticacionUsuario datosAuntenticacionUsuario) {
        Authentication authToken = new UsernamePasswordAuthenticationToken(datosAuntenticacionUsuario.login(), datosAuntenticacionUsuario.clave());
